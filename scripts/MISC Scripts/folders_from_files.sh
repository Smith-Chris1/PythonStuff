...
input=(/Volumes/videos/DROP_BIN/CIARA/VOs_for_Chris/*)
destination="/Volumes/videos/pod_videos/!Future_Videos"
...
echo -e "Creating folders for: " "$folder"
    newname="/Users/chrissmith/Desktop/FolderStructure_Test/GenericTemplate/projectname/02_project/$folder.prproj"
